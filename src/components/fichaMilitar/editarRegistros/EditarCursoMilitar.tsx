...
const EditarCursoMilitar = ({ 
  militarId,
  cursos,
  onCancel,
  onSave,
  onDelete
}: EditarCursoMilitarProps) => {
  const [editableCursos, setEditableCursos] = useState<CursoMilitar[]>(cursos);
  const [isSaving, setIsSaving] = useState(false);

  const handleInputChange = (id: string, field: keyof CursoMilitar, value: any) => {
  ...
  const handleSave = async () => {
    try {
      ...
      toast({
        title: "Cursos militares atualizados",
...
export default EditarCursoMilitar;
