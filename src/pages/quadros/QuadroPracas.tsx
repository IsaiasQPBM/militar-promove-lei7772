...
const QuadroPracas = ({ tipo }: QuadroPracasProps) => {
  ...
  const getQuadroTitle = () => {
    switch (tipo) {
      case "QPBM":
        return "Quadro de Praças Bombeiros Militares";
      case "QPRR":
        return "Quadro de Praças da Reserva Remunerada";
      default:
        return "Quadro de Praças";
    }
  };
