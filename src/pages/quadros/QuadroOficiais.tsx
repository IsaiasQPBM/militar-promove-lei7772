...
const QuadroOficiais: React.FC<QuadroOficiaisProps> = ({ quadro, titulo }) => {
  ...
  const renderPosto = (posto: string) => {
    const postoBadgeClass = {
      "Coronel": "bg-red-100 text-red-800",
      "Tenente-Coronel": "bg-orange-100 text-orange-800",
      "Major": "bg-yellow-100 text-yellow-800",
      "Capitão": "bg-green-100 text-green-800",
      "1º Tenente": "bg-blue-100 text-blue-800",
      "2º Tenente": "bg-indigo-100 text-indigo-800",
      "Aspirante": "bg-purple-100 text-purple-800",
                    ...
                    <div className="p-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="mt-1">{renderPosto(militar.posto)}</div>
                        </div>
                      </div>
